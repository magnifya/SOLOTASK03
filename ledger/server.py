    ...
    class LedgerHandler(BaseHTTPRequestHandler):
        ...
        def do_GET(self) -> None:  # noqa: N802 (stdlib naming)
            ...
            if path.startswith("/v1/transactions/"):
                ...
                # GET /v1/trust — the offline verify document; its top-level
                # key order (genesis_hash, sources, allowlist, audit_signers,
                # source_key_history) is contract-fixed, so it is serialized
                # in insertion order.
